...
Canonical **department × workflow stage × SRS persona** mapping for notebook
workflows.

## File

`ahri-workflows.csv` — loaded at startup by
`WorkflowRegistryConfigurationHandler`.
...
Sample Collector, Laboratory Technician, Junior Researcher, Senior Researcher,
Lab Manager, Biomedical Staff

## Related

- [docs/ahri-workflow-stage-matrix.md](../../../docs/ahri-workflow-stage-matrix.md)
  — traceability to SRS §3/§4
