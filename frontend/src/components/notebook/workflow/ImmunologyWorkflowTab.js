 ...
 */
const IMMUNOLOGY_WORKFLOW_PAGES = [
...
/**
 * ImmunologyWorkflowTab - Container component for immunology workflow pages.
 ...
 */
function ImmunologyWorkflowTab({ notebookId, entryId: propEntryId }) {
  ...
  const { effectivePages, activePage, setActivePage, handlePageChange } =
    usePageAccessControl(pages, IMMUNOLOGY_WORKFLOW_PAGES, 0, {
...
export default ImmunologyWorkflowTab;
