...
const REGISTRY_BY_WORKFLOW_TYPE = {
  biorepository: [
    {
      ...
      requiredActions: ["VIEW", "EDIT", "COMPLETE"],
      allowedPersonas: ["Sample Collector", "Laboratory Technician"],
    },
    {
      stageOrder: 2,
      ...
      requiredActions: ["VIEW", "EDIT", "COMPLETE"],
      allowedPersonas: ["Laboratory Technician", "Lab Manager"],
    },
    {
      stageOrder: 3,
      stageId: "monitoring",
    ...
    },
    {
      ...
      requiredActions: ["VIEW", "EDIT", "COMPLETE"],
      allowedPersonas: ["Lab Manager", "Laboratory Technician"],
    },
    {
      stageOrder: 6,
      stageId: "qc",
    ...
    },
    {
      ...
      requiredActions: ["VIEW", "EDIT", "COMPLETE"],
      allowedPersonas: ["Lab Manager", "Senior Researcher"],
    },
  ],
  immunology: [
    {
  ...
  viral_vaccine: [
    ...
    },
    {
      ...
      requiredActions: ["VIEW", "EDIT", "COMPLETE"],
      allowedPersonas: ["Senior Researcher", "Lab Manager"],
    },
  ],
};
